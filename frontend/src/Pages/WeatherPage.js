...
setError(raw.isMock === true ? true : false);
        ...
        <div className="col-md-6 mx-auto mb-4">
          ...
          {error && (
            <div className="alert alert-warning py-2 mt-2 text-center mb-0" style={{ fontSize: "0.8rem" }}>
               {hi ? "बैकएंड से कनेक्ट नहीं हो सका — डेमो डेटा दिखाया जा रहा है" : "Demo mode active — showing sample weather for"} <strong>{city}</strong>
            </div>
          )}
        </div>
